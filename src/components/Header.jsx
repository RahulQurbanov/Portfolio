...
//             <nav className='flex justify-between items-center py-5 px-[45px] text-[17px] bg-[#071726] animate__animated animate__bounce animate__delay-1s'>
...
//                 <p className='text-[#64ffda] text-[20px] animate__animated animate__fadeIn animate__delay-2s'>Hi, My name is</p>
//                 <p className='text-[#8892b0] text-[56px] font-bold animate__animated animate__fadeIn animate__delay-2s'>Rahul Qurbanov</p>
//                 <p className='text-[#495670] text-[66px] font-bold animate__animated animate__fadeIn animate__delay-3s'>I'm a Front-End Developer.!</p>
...
//                 </p>
//                 <div className='hover:skew-2 mb-[30px] animate__animated animate__fadeIn animate__delay-5s'>
//                     <a href='https://github.com/RahulQurbanov?tab=overview&from=2025-04-01&to=2025-04-29' className='py-3 px-5 text-[#64ffda] border-1 bg-[#0a192f] z-10'>
//                         Check out my Github!
//                     </a>
//                 </div>
//                 <div>
//                     <h1 className='text-[#8892b0] text-[18px] mb-[25px] animate__animated animate__fadeIn animate__delay-6s'>
//                         Here are a few technologies I’ve been working with recently:
//                     </h1>
//                     <div className="mt-2 flex gap-10 animate__animated animate__fadeIn animate__delay-7s">
