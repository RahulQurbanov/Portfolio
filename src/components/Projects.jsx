...
//                   <img src="./src/assets/img/tailwind.svg" className={`w-[35px] h-[35px] ${inView ? 'animate__animated animate__rotateIn' : ''}`} />
//                   <img src="./src/assets/img/api.svg" className={`w-[35px] h-[35px] ${inView ? 'animate__animated animate__rotateIn' : ''}`} />
//             </div>
//             <div className='flex gap-2 items-end justify-end'>
//            <a href="https://github.com/RahulQurbanov/Investment-Calculator"><img src="./src/assets/img/github1.svg" className="w-[50px] h-[50px] cursor-pointer  opacity-45 hover:opacity-100" /></a>
//             <a href=""><img src="./src/assets/img/live.svg" className="w-[40px] bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse h-[40px] cursor-pointer" /></a>
...
Users can input their desired investment amount, interest rate, and the number of months — the calculator will automatically compute the potential returns based on these values.</div>
        ...
        <div className={`w-[50%]`}>
            ...
            <div className={`w-[45%] flex flex-col gap-[15px]`}>
               ...
               <div className='w-[500px] bg-[#112240] text-gray-300 rounded-lg py-2 px-5'>This is a dynamic Quiz App built using React and styled with Tailwind CSS.
                All questions are loaded from a JSON file, and users receive points for each correct answer, while wrong answers do not reduce the score. The app offers smooth interaction, real-time feedback, and is perfect for quick knowledge testing.</div>
            <div className='flex gap-5'>
                  <img src="./src/assets/img/html.webp" className={`w-[35px] h-[35px] ${quizInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/js.png" className={`w-[35px] h-[35px] ${quizInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/react.svg" className={`w-[35px] h-[35px] ${quizInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/vite.svg" className={`w-[35px] h-[35px] ${quizInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/tailwind.svg" className={`w-[35px] h-[35px] ${quizInView ? 'animate__animated animate__rotateIn' : ''}`} />
            </div>
            <div className='flex gap-2 items-end justify-end'>
           <a href="https://github.com/RahulQurbanov/Quiz-App"><img src="./src/assets/img/github1.svg" className="w-[50px] h-[50px] cursor-pointer  opacity-45 hover:opacity-100" /></a>
            <a href="http://localhost:5173/"><img src="./src/assets/img/live.svg" className="w-[40px] bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse h-[40px] cursor-pointer" /></a>
        ...
        <div className='flex flex-row gap-[20px] justify-around mb-[95px]' ref={todoRef}>
            <div className={`w-[45%] flex flex-col gap-[15px]`}>
               ...
               <div className='w-[500px] bg-[#112240] text-gray-300 rounded-lg py-2 px-5'>This project is a To-Do List Application built with React and Vite. The application features two separate sections: Active and Done — allowing users to efficiently organize their tasks. Users can easily add new tasks, edit task names, mark them as completed, or delete them. The app offers a smooth and intuitive experience, making task management clear and convenient.</div>
            <div className='flex gap-5'>
            <img src="./src/assets/img/html.webp" className={`w-[35px] h-[35px] ${todoInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/js.png" className={`w-[35px] h-[35px] ${todoInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/react.svg" className={`w-[35px] h-[35px] ${todoInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/vite.svg" className={`w-[35px] h-[35px] ${todoInView ? 'animate__animated animate__rotateIn' : ''}`} />
            </div>
            <div className='flex gap-2 items-end justify-end'>
           <a href="https://github.com/RahulQurbanov/Todo-List-"><img src="./src/assets/img/github1.svg" className="w-[50px] h-[50px] cursor-pointer  opacity-45 hover:opacity-100" /></a>
            <a href="https://rahulqurbanov.github.io/Todo-List-/"><img src="./src/assets/img/live.svg" className="w-[40px] bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse h-[40px] cursor-pointer" /></a>
        ...
        <div className={`w-[50%]`}>
            ...
            <div className={`w-[45%] flex flex-col gap-[15px]`}>
               ...
               <div className='w-[500px] bg-[#112240] text-gray-300 rounded-lg py-2 px-5'>This project is designed as an online course platform. It was fully built using HTML, CSS, and JavaScript. The website layout is clean and responsive, featuring sections for courses, instructors, and interactive elements to simulate a real e-learning experience.</div>
            <div className='flex gap-5'>
            <img src="./src/assets/img/html.webp" className={`w-[35px] h-[35px] ${koolCodersInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/css.svg" className={`w-[35px] h-[35px] ${koolCodersInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/js.png" className={`w-[35px] h-[35px] ${koolCodersInView ? 'animate__animated animate__rotateIn' : ''}`} />
            </div>
            <div className='flex gap-2 items-end justify-end'>
           <a href="https://github.com/RahulQurbanov/Project-KoolCoders"><img src="./src/assets/img/github1.svg" className="w-[50px] h-[50px] cursor-pointer  opacity-45 hover:opacity-100" /></a>
            <a href="https://rahulqurbanov.github.io/Project-KoolCoders/"><img src="./src/assets/img/live.svg" className="w-[40px] bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse h-[40px] cursor-pointer" /></a>
        ...
        <div className='flex flex-row gap-[20px] justify-around'  ref={weatherRef}>
            <div className={`w-[45%] flex flex-col gap-[15px]`}>
               ...
               <div className='w-[500px] bg-[#112240] text-gray-300 rounded-lg py-2 px-5'>This project was built using HTML, CSS, and JavaScript. It fetches real-time 7-day weather forecasts for any city worldwide using the OpenWeather API. The user can search for a city, and the app displays accurate and up-to-date weather information in a clean and user-friendly design.</div>
            <div className='flex gap-5'>
            <img src="./src/assets/img/html.webp" className={`w-[35px] h-[35px] ${weatherInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/css.svg" className={`w-[35px] h-[35px] ${weatherInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/js.png" className={`w-[35px] h-[35px] ${weatherInView ? 'animate__animated animate__rotateIn' : ''}`} />
                  <img src="./src/assets/img/api.svg" className={`w-[35px] h-[35px] ${weatherInView ? 'animate__animated animate__rotateIn' : ''}`} />
            </div>
            <div className='flex gap-2 items-end justify-end'>
           <a href="https://github.com/RahulQurbanov/Weather-prognoz"><img src="./src/assets/img/github1.svg" className="w-[50px] h-[50px] cursor-pointer  opacity-45 hover:opacity-100" /></a>
            <a href="https://rahulqurbanov.github.io/Weather-prognoz/"><img src="./src/assets/img/live.svg" className="w-[40px] bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-pulse h-[40px] cursor-pointer" /></a>
